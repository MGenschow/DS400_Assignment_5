...
2. Now the loop can be constructed. Data cleaning will happen inside the loop, such that in each iteration, 500 new entries will be appended to the dataframe.
```{r}
all_data = data.frame()
